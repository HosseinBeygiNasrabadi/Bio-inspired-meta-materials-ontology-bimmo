 ...
 * [bimmo.yml](bimmo.yml)
     * Determines how your purl.obolibrary.org/obo/bimmo/ redirects will be handled
     ...
     * Paste in the contents of [bimmo.yml](bimmo.yml)
 ...
 * [bimmo.md](bimmo.md)
     ...
     * Paste in the contents of [bimmo.md](bimmo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
